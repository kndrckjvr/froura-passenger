...
public class LoginDriverTasks extends AsyncTask<Void, Void, String> {
    public static void execute(Context context) {
        new LoginDriverTasks(context).execute();
    }
    ...
    public LoginDriverTasks(Context context) {
    ...
    protected String doInBackground(Void... params) {
        try {
            ...
            String postString = ((OnLoginDriverTasksListener)context).createCheckNotifsPostString(new ContentValues());
    ...
    protected void onPostExecute(String jsonString) {
        ...
        try {
            ((OnLoginDriverTasksListener)context).parseCheckNotifsJSONString(jsonString);
        } catch (Exception e) {}
    }
}
