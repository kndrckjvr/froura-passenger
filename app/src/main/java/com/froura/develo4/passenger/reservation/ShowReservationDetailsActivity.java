...
public class ShowReservationDetailsActivity extends AppCompatActivity
    ...
    private TextView status_txt_vw;
    private LinearLayout reservation_details_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reservation_details_layout = findViewById(R.id.reservation_details_layout);
        ...
        status_txt_vw = findViewById(R.id.status_txt_vw);
        ...
        status_txt_vw.setText(status[getIntent().getIntExtra("status", 0)]);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        mMap.setPadding(0, 0,
                0, reservation_details_layout.getLayoutParams().height);
